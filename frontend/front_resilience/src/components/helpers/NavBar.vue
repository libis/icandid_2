  ...
  <nav class="navbar" role="navigation" aria-label="main navigation">
    <div class="navbar-brand">
      <a class="navbar-item" href="/#/">
        <img src="/img/Logo_ReIReSearch.png" height="40" />
      </a>
    ...
    <div id="navbarBasicExample"  ref="navbarBasicExample" class="navbar-menu">
      ...
      <div class="navbar-end">
        <div v-for="m in menu" :key="m.id">
          <a v-if="m.route" style="font-weight: 600;" class="navbar-item is-hidden" :href="m.route" ref="mi" :id="m.vis" :target="((m.route.substring(0, 4) == 'http')?'_blank':'')">{{ m.name }}</a>
          <div v-if="m.submenu" style="font-weight: 600;" class="navbar-item has-dropdown is-hoverable is-hidden" ref="mi" :id="m.vis">
            ...
            <div class="navbar-dropdown">
              <div v-for="n in m.submenu" :key="n.id">
                <a
                  ...
                  @click="closeMenu"
                >{{ n.name }}</a>
                <hr v-else ref="mi" :id="n.vis" class="navbar-divider" />
              </div>
            </div>
          </div>
        </div>
