    ...
    <div class="block">
        ...
        <div class="columns">
            ...
            <div class="column is-half">
                ...
                <iframe width="560" height="315" src="https://www.youtube.com/embed/Sq87ZJuiVP0?si=4K4Mk6U89ie9nPIT" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
        </div>
    </div>
</template>
...
/*            if (this.getPermissions.indexOf("search_collections") >= 0) {
            ...
            if (this.$cookies.get('wantsaccess') && this.$route.name != "Access") {
